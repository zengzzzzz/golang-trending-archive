...
* 【2024-03-24】[mshumer / gpt-prompt-engineer](https://github.com/mshumer/gpt-prompt-engineer) - 
...
* 【2024-03-02】[microsoft / Security-101](https://github.com/microsoft/Security-101) - 7 Lessons, Kick-start Your Cybersecurity Learning.
...
* 【2024-03-27】[arco-design / arco-design-vue](https://github.com/arco-design/arco-design-vue) - A Vue.js 3 UI Library based on Arco Design
...
* 【2024-03-09】[ComfyWorkflows / ComfyUI-Launcher](https://github.com/ComfyWorkflows/ComfyUI-Launcher) - Run any ComfyUI workflow w/ ZERO setup.
* 【2024-03-09】[orodrigogo / react-native-na-pratica-2](https://github.com/orodrigogo/react-native-na-pratica-2) - 🎯🤑💵💰 App de metas financeiras pessoal.
* 【2024-03-09】[yamada-ui / yamada-ui](https://github.com/yamada-ui/yamada-ui) - React UI components of the Yamada, by the Yamada, for the Yamada built with React and Emotion.
...
* 【2024-03-06】[apitable / apitable](https://github.com/apitable/apitable) - 🚀🎉📚 APITable, an API-oriented low-code platform for building collaborative apps and better than all other Airtable open-source alternatives.
...
* 【2024-03-04】[lmsqueezy / wedges](https://github.com/lmsqueezy/wedges) - An ever-expanding, open-source React UI library built with the Wedges Design System, Radix primitives, and Tailwind CSS.
* 【2024-03-04】[semperai / amica](https://github.com/semperai/amica) - Amica is an open source interface for interactive communication with 3D characters with voice synthesis and speech recognition.
* 【2024-03-04】[openreplay / openreplay](https://github.com/openreplay/openreplay) - Session replay and analytics tool you can self-host. Ideal for reproducing issues, co-browsing with users and optimizing your product.
* 【2024-03-04】[Slowlydev / f1-dash](https://github.com/Slowlydev/f1-dash) - A real-time F1 dashboard
* 【2024-03-04】[LLOneBot / LLOneBot](https://github.com/LLOneBot/LLOneBot) - LiteloaderQQNT的OneBot API插件
* 【2024-03-03】[bangbang93 / openbmclapi](https://github.com/bangbang93/openbmclapi) - BMCLAPI@Home
...
* 【2024-03-02】[ajnart / homarr](https://github.com/ajnart/homarr) - Customizable browser's home page to interact with your homeserver's Docker containers (e.g. Sonarr/Radarr)
* 【2024-03-01】[redis / ioredis](https://github.com/redis/ioredis) - 🚀 A robust, performance-focused, and full-featured Redis client for Node.js.
* 【2024-03-01】[teambit / bit](https://github.com/teambit/bit) - A build system for development of composable software.
* 【2024-03-01】[razorpay / blade](https://github.com/razorpay/blade) - Design System that powers Razorpay
* 【2024-03-01】[tsparticles / tsparticles](https://github.com/tsparticles/tsparticles) - tsParticles - Easily create highly customizable JavaScript particles effects, confetti explosions and fireworks animations and use them as animated backgrounds for your website. Ready to use components available for React.js, Vue.js (2.x and 3.x), Angular, Svelte, jQuery, Preact, Inferno, Solid, Riot and Web Components.
* 【2024-03-01】[peter-evans / create-pull-request](https://github.com/peter-evans/create-pull-request) - A GitHub action to create a pull request for changes to your repository in the actions workspace
